...
class CastRepository {
  ...
  static const id=602269;

  static Future<CastResponse> getCast(int id) async {

    var response = await http.get('${BASE_URL()}/$id/credits?api_key=6fbf3b1a515fe8ef2c494c4fe8085a6a',
        headers: {
